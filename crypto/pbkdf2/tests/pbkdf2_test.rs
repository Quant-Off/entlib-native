...
mod tests {
    ...
    fn pbkdf2_hmacsha256_valid_password() {
        ...
        let expected = [
            0xf1u8, 0xdb, 0xae, 0x96, 0xc8, 0x47, 0xde, 0x21,
            0x1b, 0xff, 0x54, 0x04, 0x51, 0xf3, 0xf6, 0x2b,
            0x35, 0xc4, 0x25, 0x45, 0xdc, 0xb7, 0xb4, 0xff,
            0x2b, 0x0f, 0x29, 0x20, 0x55, 0x5c, 0x37, 0xd0,
        ];
