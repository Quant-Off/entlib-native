...
mod tests {
    ...
    fn nist_cavp_aes256_gcm_encrypt() {
        ...
        let aad = [
            ...
            0xde,0xad,0xbe,0xef,0xab,0xad,0xda,0xd2u8,
        ];
        let pt = [
        ...
        let expected_ct = [
            ...
            0xc5,0xf6,0x1e,0x63,0x93,0xba,0x7a,0x0a,0xbc,0xc9,0xf6,0x62u8,
        ];
    ...
    fn nist_aes256_cbc_hmac_encrypt() {
        ...
        let pt = [
            ...
            0x30,0xc8,0x1c,0x46,0xa3,0x5c,0xe4,0x11,0xe5,0xfb,0xc1,0x19,0x1a,0x0a,0x52,0xefu8,
        ];
        let expected_ct = [
            0xf5,0x8c,0x4c,0x04,0xd6,0xe5,0xf1,0xba,0x77,0x9e,0xab,0xfb,0x5f,0x7b,0xfb,0xd6,
            0x9c,0xfc,0x4e,0x96,0x7e,0xdb,0x80,0x8d,0x67,0x9f,0x77,0x7b,0xc6,0x70,0x2c,0x7d,
            0x39,0xf2,0x33,0x69,0xa9,0xd9,0xba,0xcf,0xa5,0x30,0xe2,0x63,0x04,0x23,0x14,0x61,
            0x2f,0x8d,0xa7,0x07,0x64,0x3c,0x90,0xa6,0xf7,0x32,0xb3,0xde,0x1d,0x3f,0x5c,0xeeu8,
        ];
        let expected_mac: [u8; 32] = [
            0xa2,0xfa,0xcb,0x5d,0xa7,0xd3,0x35,0x49,0xd8,0x26,0x40,0x3b,0xe7,0x39,0xd5,0xae,
            0x21,0x25,0x14,0x2c,0xc8,0x26,0xa6,0xb6,0xc9,0xfc,0x83,0x97,0x06,0x0d,0x52,0x56,
        ];
